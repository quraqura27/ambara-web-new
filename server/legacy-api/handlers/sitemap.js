...
exports.handler = async (event) => {
  ...
  const staticPages = [
    ...
    { path: '/en/indonesia-customs-clearance.html', priority: '0.9', changefreq: 'monthly' },
    ...
    { path: '/en/hs-code-checker.html', priority: '0.8', changefreq: 'monthly' },
    { path: '/id/hs-code-checker.html', priority: '0.8', changefreq: 'monthly' },
