...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-[#020617] text-slate-50">
      {/* Sidebar - Desktop */}
      <aside className="hidden lg:flex w-64 flex-col bg-[#0f172a]/50 border-r border-slate-800/50">
        <div className="p-6">
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        {/* Header */}
        <header className="h-16 border-b border-slate-800/50 bg-[#0f172a]/50 backdrop-blur-xl flex items-center justify-between px-6 z-10">
          <button 
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <nav className="absolute left-0 top-0 bottom-0 w-72 bg-[#0f172a] border-r border-slate-800 p-6 flex flex-col">
